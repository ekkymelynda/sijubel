        ...
        <div>
          <ul class="site-menu">
            <li class="site-menu-category">ADMIN</li>
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/akun_lihat" data-slug="uikit-colors">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Lihat</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/akun_ubah" data-slug="uikit-dropdowns">
                    <i class="site-menu-icon " aria-hidden="true"></i>
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/pegawai_buat" data-slug="uikit-buttons">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Buat</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/pegawai_lihat" data-slug="uikit-colors">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Lihat</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/pegawai_ubah" data-slug="uikit-dropdowns">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Ubah</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/pegawai_hapus" data-slug="uikit-list">
                    <i class="site-menu-icon " aria-hidden="true"></i>
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/supplier_buat" data-slug="advanced-animation">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Buat</span>
                  </a>
                </li>
                <li class="site-menu-item active">
                  <a class="animsition-link" href="<?php echo base_url(); ?>Pemilik/supplier_lihat" data-slug="advanced-lightbox">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Lihat</span>
                  </a>
                </li>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">Lihat Data Supplier</h1>
      <ol class="breadcrumb">
        <li>Supplier</li>
        <li>Lihat</li>
      </ol>
    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading">
          ...
          <h3 class="panel-title">Lihat Data Supplier</h3>
        </header>
          ...
          <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
            ...
            <tbody>
              ...
              <tr>
                 ...
                 <td><?php echo $row->NAMA_SPL;?></td>
                 <td><?php echo $row->PERUSAHAAN_SPL;?></td>
                 <td><?php echo $row->NOTLP_SPL;?></td>
